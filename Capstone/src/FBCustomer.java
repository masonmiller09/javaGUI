...
public class FBcustomerRS
{
    ...
    public FBcustomerRS(Connection aConnR, Connection aConnL, boolean aIsConnected, String aLastName, String aFirstName, String aStreetAddress, String aApartmentNumber, String aCity, int aZipCode,
            ...
            int aIncYearly, int aOffender) throws SQLException
    {
        ...
        if(isConnected)
        {
            PreparedStatement prepR = connR.prepareStatement("insert into jos_fb_customer values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
            ...
            */
            ...
            prepR.addBatch();
            System.out.println(prepR.toString());
    ...
    public FBcustomerRS(Connection aConnR, Connection aConnL, boolean aIsConnected, int aCustomerID) throws SQLException
    {
    ...
    public String getFirstName()
    {
        ...
        if(isConnected)
        {
            try
            {
                String sql = "SELECT * FROM jos_fb_customer WHERE Customer_ID = " + customer_ID;
                stmtR = connR.createStatement();
                rsR = stmtR.executeQuery(sql);
                rsR.next();
    ...
    public String setFirstName(String aFirstName)
    {
        if(isConnected)
        {
            try
            {
                /*String sql = "UPDATE jos_fb_customer SET First_Name = ? WHERE Customer_ID = ?";
                ...
                return st.toString();*/
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET First_Name= '" + aFirstName + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setLastName(String aLastName)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Last_Name= '" + aLastName + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setAddress(String aAddress)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Street_Address= '" + aAddress + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setApt_Num(String aAptNum)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Apartment_Number= '" + aAptNum + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setCity(String aCity)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET City= '" + aCity + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setZip_Code(int aZipCode)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Zip_Code= '" + aZipCode + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setPhone_Num(long aPhoneNum)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Phone_Number= '" + aPhoneNum + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setNum_Children(int aNumChildren)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Number_Children= '" + aNumChildren + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                setTotal_Household();
                return sql;
    ...
    public String setNum_Adults(int aNumAdults)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Number_Adults= '" + aNumAdults + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                setTotal_Household();
                return sql;
    ...
    public String setNum_Seniors(int aNumSeniors)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Number_Seniors= '" + aNumSeniors + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                setTotal_Household();
                return sql;
    ...
    public String setTotal_Household()
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Total_Household= '" + (getNum_Children()+ getNum_Adults() + getNum_Seniors()) + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setFoodStamps_Snap(int aFoodStamps)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET FoodStamps_SNAP= '" + aFoodStamps + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setTanf(int aTANF)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET TANF= '" + aTANF + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setSsi(int aSSI)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET SSI= '" + aSSI + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setMedicaid(int aMedicaid)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Medicaid= '" + aMedicaid + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setHh_Income(int aHh_Income)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET HH_Income= '" + aHh_Income + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setInc_Monthly(int aInc_Monthly)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Inc_Monthly= '" + aInc_Monthly + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setInc_Weekly(int aIncWeekly)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Inc_Weekly= '" + aIncWeekly + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setInc_Yearly(int aIncYearly)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Inc_Yearly= '" + aIncYearly + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
    ...
    public String setOffender(int aOffender)
    {
        if(isConnected)
        {
            ...
            {
                connR.setAutoCommit(true);
                String sql = "UPDATE jos_fb_customer SET Offender= '" + aOffender + "' WHERE Customer_ID=" + customer_ID;
                PreparedStatement st = connR.prepareStatement(sql);
                st.execute();
                return sql;
            }
