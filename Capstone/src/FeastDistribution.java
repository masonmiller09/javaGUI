...
public class FeastDistribution extends JFrame
{
    ...
    private String[] distributionOptions = { "", "Dist1", "Dist2", "Dist3",
        "Dist4" };
    ...
    public FeastDistribution( Connection conL, boolean isconnect )
    {
        super( "Distribution" );
        ...
        searchButton.addActionListener( new ActionListener()
        {
            public void actionPerformed( ActionEvent e )
            {
                ...
                {
                    request = new String( "SELECT * FROM jos_fb_monthlyDist WHERE "
                        + option + " LIKE  \'" + text + "%\'" );
                }
                try
                {
        ...
        model = new DistributionTableModel( connL, online, DEFAULT_QUERY );
    ...
    {
        String dis = (String)JOptionPane.showInputDialog( this,
            "Which Distribution Agency?",
            "Distribution Site",
    ...
    {
        String dis = (String)JOptionPane.showInputDialog( this,
            "Please actually select a Distribution site!",
            "Distribution Site",
            JOptionPane.QUESTION_MESSAGE,
            null,
            distributionOptions,
    ...
    private String enterDateDialog()
    {
        String code = JOptionPane.showInputDialog( this,
            "Enter the date for the new Distribution with the following format \n YYYY-MM-DD",
            "Distribution Date",
            JOptionPane.QUESTION_MESSAGE );
        return code;
    }
    ...
    {
        String code = JOptionPane.showInputDialog( this,
            "Please enter the date for the new Distribution! \n Example: 2013-03-25",
            "Distribution Date",
            JOptionPane.QUESTION_MESSAGE );
        return code;
    }
    ...
    {
        String code = JOptionPane.showInputDialog( this,
            "Please enter the date of a Distribution \n Example: YYYY-MM-DD",
            "Distribution Date",
            JOptionPane.QUESTION_MESSAGE );
        return code;
    }
    ...
    {
        String code = JOptionPane.showInputDialog( this,
            "Please enter the date for an valid Distribution! \n Example: 2013-03-25",
            "Distribution Date",
            JOptionPane.QUESTION_MESSAGE );
        return code;
    }
    ...
    class DistributionTableModel extends AbstractTableModel
    {
        ...
        private String SIZE_DATABASE_QUERY = "SELECT COUNT(Customer_ID) FROM jos_fb_customer;";
    ...
    /*
     * public static void main( String[] args ) { JFrame GUI = new
     * FeastDistribution(); GUI.setLocationRelativeTo( null ); GUI.setVisible(
     * true ); }
     */
}
